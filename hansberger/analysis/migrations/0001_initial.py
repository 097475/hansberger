    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(blank=True, default=None, help_text='Select the source dataset from the loaded datasets', on_delete=django.db.models.deletion.CASCADE, to='datasets.Dataset')),
